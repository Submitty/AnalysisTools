...
int main() {
  ...
  //int test
    ...
    intTest.push_back(2);
    intTest.push_back(1);
    intTest.push_back(50);
    cout << "num removed: " << remove_matching_elements(intTest, 1) << endl;
    intTest.print(); 
   

    //double test
    Vec<double> doubleTest;
    doubleTest.push_back(0.0);
    doubleTest.push_back(4421.123);
    doubleTest.push_back(500.0);
    doubleTest.push_back(1.1);
    cout << "num removed: " << remove_matching_elements(doubleTest, 1.1) << endl;
    doubleTest.print(); 

    //string test
    Vec<string> stringTest;
    string s = "cat";
    stringTest.push_back("a");
    stringTest.push_back("cat");
    stringTest.push_back("dog");
    stringTest.push_back("CAT");
    stringTest.push_back("Cat");
    cout << "num removed: " << remove_matching_elements(stringTest, s) << endl;
    stringTest.print(); 

    Vec<int> noneTest;
    noneTest.push_back(0);
    noneTest.push_back(1);
    noneTest.push_back(2);
    cout << "num removed: " << remove_matching_elements(noneTest, 15) << endl;
    noneTest.print(); 
